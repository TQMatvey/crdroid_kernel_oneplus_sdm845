...
Rebased on the official lineage-20 branch from LineageOS as of October 2022, with some extra goodies added in like clang 12-14 support, wireguard support, and fixed wifi drivers that should 1) actually turn on, and 2) not go to crashdump mode if you try to tether. Fancy!
